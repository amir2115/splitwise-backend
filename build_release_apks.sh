...
SPLITWISE_VERSION_CODE="1"
SPLITWISE_VERSION_NAME="1.0.0"
...
build_variant() {
  ...
  cp "$apk_path" "$SCRIPT_DIR/$apk_output_name"
  cp "$aab_path" "$SCRIPT_DIR/$aab_output_name"
  echo "Saved: $SCRIPT_DIR/$apk_output_name"
  echo "Saved: $SCRIPT_DIR/$aab_output_name"
}
...
echo ""
echo "All release APKs and AABs are ready next to this script:"
echo "- $SCRIPT_DIR/app-bazaar-release.apk"
echo "- $SCRIPT_DIR/app-bazaar-release.aab"
echo "- $SCRIPT_DIR/app-myket-release.apk"
echo "- $SCRIPT_DIR/app-myket-release.aab"
echo "- $SCRIPT_DIR/app-organic-release.apk"
echo "- $SCRIPT_DIR/app-organic-release.aab"
